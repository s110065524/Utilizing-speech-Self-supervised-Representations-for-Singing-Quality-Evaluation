...
class SpectralCRNN_Reg_Dropout_CQT_w2v(nn.Module):
    def __init__(self):
        super(SpectralCRNN_Reg_Dropout_CQT_w2v, self).__init__()
        self.conv1 = nn.Sequential(
            # Conv Layer 1
            nn.Conv2d(1, 32, kernel_size=(3, 7), padding=(1, 3)),
            #nn.Dropout2d(0.6),
...
class SpectralCRNN_Reg_Dropout_CQT_w2v_ph(nn.Module):
    def __init__(self):
        super(SpectralCRNN_Reg_Dropout_CQT_w2v_ph, self).__init__()
        self.conv1 = nn.Sequential(
            # Conv Layer 1
            nn.Conv2d(1, 32, kernel_size=(3, 7), padding=(1, 3)),
            #nn.Dropout2d(0.6),
