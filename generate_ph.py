...
def extract_pitch(wavfile, pitchfile, hop):
    ...
    pitch_extract_cmd = r'C:\Praat.exe --run C:\ExtractPitch.praat '+wavfile+  ' ' + pitchfile + ' ' + str(pitch_ceiling) + ' ' + str(hop)
    try :
        os.system(pitch_extract_cmd)
    except:
        print('run Praat fail')
...
bwsfolder = mother_dir + os.sep + 'bws'
wavfolder = "D:\DAMP\SingEval_DAMPcurated"
songnames = [
...
for songname in songnames:
    ...
    wav_folder = "D:\DAMP\Research\write_wav"
    pitch_folder = 'D:\DAMP\Research\pitch_folder'
